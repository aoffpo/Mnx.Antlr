...
FOR_UPDATE : FOR{Whitespace} UPDATE;	////FOR_UPDATE : FOR{Whitespace}+UPDATE;
WITH_CHECK_OPTION : WITH{Whitespace} CHECK{Whitespace} OPTION;////WITH_CHECK_OPTION : WITH{Whitespace}+CHECK{Whitespace}+OPTION;
//**ACTION : '$ACTION';////_ACTION : '$ACTION'; //TODO
